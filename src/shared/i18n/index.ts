  ...
  uz: {
    translation: {
      ...
      checkout: {
        ...
        paymentProofModalTitle: "To'lov chekini yuklang",
        paymentProofModalDescription: "Buyurtmani yuborishdan oldin to'lov tasdig'i rasmini biriktiring.",
        paymentProofPreviewAlt: "To'lov cheki rasmi",
        paymentProofEmptyTitle: "Chek rasmi hali tanlanmagan",
        paymentProofEmptyDescription: "Payme yoki Click to'lovi uchun skrinshot yoki chek rasmini yuklang.",
        ...
        paymentProofUpload: "Rasm yuklash",
        paymentProofReplace: "Rasmni almashtirish",
        paymentProofRemove: "O'chirish",
        paymentProofConfirm: "Buyurtmani yuborish",
        paymentProofRequiredTitle: "To'lov cheki kerak",
        paymentProofRequiredMessage: "Davom etish uchun to'lov tasdig'i rasmini yuklang.",
  ...
  ru: {
    translation: {
      ...
      checkout: {
        ...
        paymentProofModalTitle: "Загрузите чек оплаты",
        paymentProofModalDescription: "Перед отправкой заказа прикрепите изображение с подтверждением оплаты.",
        paymentProofPreviewAlt: "Изображение чека оплаты",
        paymentProofEmptyTitle: "Чек еще не выбран",
        paymentProofEmptyDescription: "Для оплаты через Payme или Click загрузите скриншот или фото чека.",
        ...
        paymentProofUpload: "Загрузить фото",
        paymentProofReplace: "Заменить фото",
        paymentProofRemove: "Удалить",
        paymentProofConfirm: "Отправить заказ",
        paymentProofRequiredTitle: "Нужен чек оплаты",
        paymentProofRequiredMessage: "Чтобы продолжить, загрузите изображение с подтверждением оплаты.",
