  ...
  uz: {
    translation: {
      ...
      checkout: {
        ...
        description: "Bog'lanish ma'lumotlarini kiriting va buyurtmangizni tasdiqlang.",
        ...
        contactTitle: "Yetkazib berish uchun ma'lumotlar",
        nameLabel: "Ismingiz",
  ...
  ru: {
    translation: {
      ...
      checkout: {
        ...
        contactTitle: "Данные для доставки",
        nameLabel: "Ваше имя",
